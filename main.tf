...
resource "aws_key_pair" "deployer-key" {
  key_name      = "${var.project_name}-deployer-key" #nombre del project-(deployer-key)
...
resource "aws_ebs_volume" "web" {
  ...
  size              = 4 #Tamanho del disco en Gigas
  type = "gp3"
  encrypted =   true
  tags = {
...
#   Security group permitiendo SSH 
...
#   Security group permitiendo HTTP 
...
// De aqui pa arriba tenemos configurada la parte web. 

// De aqui pa abajo, van los outputs y las IPs
